...
class SocketServer:
	def __init__(self, ip, port):
		"""
		Initialize the SocketServer with the given IP address and port.
	...
	def start_server(self):
		"""
		Start the server to accept and handle incoming client connections.
		"""
...
class GameServer(SocketServer):
	...
	def broadcast(self, sender_id, message):
		...
		If the message starts with an asterisk, it will be sent to all clients.

		:param sender_id: The ID of the client sending the message.
		:param message: The message to be broadcasted to all clients.
		"""
	def broadcast(self, sender_id, message):
